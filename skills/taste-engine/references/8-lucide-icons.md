...
> **Core Philosophy**: *Icons are functional semantic anchors, not decorative wallpaper. Every icon must serve a distinct cognitive purpose.*
...
* ❌ **Never put random 3D icons inside every bento box**: Icons should never replace actual UI mockups, metrics, or data previews.
